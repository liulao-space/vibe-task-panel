...
import { loadAllTasks, loadTask, saveTask, pushNotice } from '../core/store.mjs';
...
const TOOLS = [
  ...
  { name: 'vtp_update_task', description: '更新任务字段（如 files/changes/sessions/acceptance 等）', inputSchema: { type: 'object', properties: { id: { type: 'string' }, patch: { type: 'object' } }, required: ['id', 'patch'] } },
